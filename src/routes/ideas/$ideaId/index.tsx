...
function IdeaDetailsPage() {
  ...
  const handleDelete = async () => {
    const confirmDelete = window.confirm(
      "Are you sure yo uwant to delete this idea?",
    );
    if (confirmDelete) {
      await deleteMutate();
    }
  ...
  return (
    <div className="p-4">
      ...
      <button
        ...
        disabled={isPending}
        className="text-sm bg-red-600 text-white mt-4 px-4 py-2 rounded transition hover:bg-red-700 disable:opacity:50 hover:cursor-pointer"
      >
